export default {
  ...
  form: {
    system: {
      ...
      dateTimeFormat: 'Muundo wa Tarehe na Wakati',
      ...
      notificationLogRetentionDays: 'Uhifadhi wa kumbukumbu za arifa (Katika Siku)',
      accessTokenRetentionDays: 'Uhifadhi wa tokeni za ufikiaji (Katika Siku)',
