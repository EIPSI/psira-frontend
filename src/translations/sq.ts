export default {
  ...
  form: {
    system: {
      ...
      dateTimeFormat: 'Vendosni Formatin e Datës dhe Kohës',
      ...
      notificationLogRetentionDays: 'Ruajtja e regjistrave të njoftimeve (në ditë)',
      accessTokenRetentionDays: 'Ruajtja e tokenëve të aksesit (në ditë)',
